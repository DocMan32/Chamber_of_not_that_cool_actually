...
public:
 ...
 void BattleGO(Mob& Ganon, Mob& Ganon2)
{
	 Gambling gambit;
	 ...
	 for (Ganon.health > 0 ; Ganon2.health > 0; ++i )
	 {
		 if (Ganon.health >= 0 && Ganon2.health >= 0)
		 {
			 ...
			 else if (Ganon.health > 0)
			 {
				 ...
				 else if (gambit.LinkIsRich == false)
				 {
			 ...
			 else if (Ganon2.health > 0 && gambit.LinkIsRich == false)
			 {
